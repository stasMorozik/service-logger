...
export interface GetListLogsPort {
    get(paginationValueObject: PaginationValueObject, filterValueObject: FilterValueObject | null, sortingValueObject: SortingValueObject | null): Promise<Either<InfrastructureError, LogEntity[]>>;
}
